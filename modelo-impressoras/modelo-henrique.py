...
where esquema.name like 'dbo' and tabela.name like 'impressoras_stg') 
create table dbo.impressoras_stg ( id INT NOT NULL IDENTITY(1,1) PRIMARY KEY, nome varchar(50), ip varchar(50)
