...
# =====================================================================
#CURSO: https://www.youtube.com/watch?v=LPvchXRbstA
# Data Generation
        ...
        dbc.Row([
            dbc.Col([
                    ...
                    dbc.Row([
                        dbc.Col([dbc.Card([   
                                dbc.CardBody([
                                    html.Span("Impressoras ativas:", className="card-text"),
                        ...
                        dbc.Col([dbc.Card([   
                                dbc.CardBody([
                                    html.Span("Impressoras Inativas", className="card-text"),
                        ...
                        dbc.Col([dbc.Card([   
                                dbc.CardBody([
                                    html.Span("Impressoras total", className="card-text"),
